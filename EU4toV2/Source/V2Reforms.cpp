...
void V2Reforms::governmentEffects(const EU4Country* srcCountry)
{
...
void V2Reforms::flagEffects(const EU4Country* srcCountry)
{
...
void V2Reforms::modifierEffects(const EU4Country* srcCountry)
{
