...
function P.NavalTechs(voTechnologyData)
	...
	preferTech = {
	 ...
	 elseif(voTechnologyData.icTotal < 75) then --antiarcraft to 2 beacuse the starting units and becasue AA are upgradable
		...
		{"battlecruiser_engine", 0},
		{"battlecruiser_armour", 0},
		{"battleship_antiaircraft", 1},
		{"battleship_engine", 1},
		{"battleship_armour", 1},
		{"super_heavy_battleship_technology", 0},
		{"carrier_antiaircraft", 3},
		{"carrier_engine", 3},
		{"carrier_armour", 2},
		{"carrier_hanger", 2},
		{"largewarship_radar", 0}};
